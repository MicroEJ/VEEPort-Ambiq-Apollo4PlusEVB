...
jlong Java_com_microej_core_tests_MicroejCoreValidation_testNativeArguments03(jint i1, jlong l2, jint i3, jlong l4, jint i5, jlong l6, jint i7, jlong l8, jint i9, jlong l10){
    ...
    if((i1==(jint)0x85868788U) &&
       (l2==(jlong)0x898A8B8C8D8E8F90llU) &&
       (i3==(jint)0x91929394U) &&
       (l4==(jlong)0x95969798999A9B9CllU) &&
       (i5==(jint)0x9D9E9FA0U) &&
       (l6==(jlong)0xA1A2A3A4A5A6A7A8llU) &&
       (i7==(jint)0xA9AAABACU) &&
       (l8==(jlong)0xADAEAFB0B1B2B3B4llU) &&
       (i9==(jint)0xB5B6B7B8U) &&
       (l10==(jlong)0xB9BABBBCBDBEBFC0llU)){
        ret = (jlong)0xC1C2C3C4C5C6C7C8llU;
    }
    return ret;
}
