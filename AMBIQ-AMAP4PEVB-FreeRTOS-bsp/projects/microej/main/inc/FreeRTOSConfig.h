...
#if defined(HIGH_PERFORMANCE_MODE)
...
#define MAX_STIMER_VALUE                        0xFFFFFFFF

#define configSTIMER_RATE_HZ                  ((int64_t)6000000)
#define configSTIMER_SRC                      AM_HAL_STIMER_HFRC_6MHZ
...
extern uint32_t am_freertos_sleep(uint32_t time);
extern void am_freertos_wakeup(uint32_t time);
