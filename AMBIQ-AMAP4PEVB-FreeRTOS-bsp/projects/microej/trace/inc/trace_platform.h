 ...
 */
#define TRACE_PLATFORM_GROUP_NAME		"APOLLO4"
 ...
 */
#define TRACE_PLATFORM_GROUP_NEMA		100
#define TRACE_PLATFORM_GROUP_LLUIDISPLAY	200
#define TRACE_PLATFORM_GROUP_LLEXT	300

/*
 *  @brief HW fake tasks ids
 *
 */
#define HW_TASK_DSI_ID 0xAADD
#define HW_TASK_GPU_ID 0xAAFF

/*
 *  @brief HW fake tasks names list
 *  Last listed will have highest priority
 */
#define HW_TASK_NAME_LIST {"DSI", "GPU"}
#define HW_TASK_ID_LIST   {HW_TASK_DSI_ID, HW_TASK_GPU_ID}

#define TRACE_HW_TASK_START(id)  TRACE_PLATFORM_HW_task_start(id)
#define TRACE_HW_TASK_STOP(id)   TRACE_PLATFORM_HW_task_stop(id)
 ...
 */
void TRACE_PLATFORM_HW_tasks_send_task_list(void);

/*
 * @brief Sends "start" event of hardware task
 */
void TRACE_PLATFORM_HW_task_start(uint32_t HW_task_id);

/*
 * @brief Sends "stop" event of hardware task
 */
void TRACE_PLATFORM_HW_task_stop(uint32_t HW_task_id);
